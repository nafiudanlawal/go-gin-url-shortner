...
public class ShortUrl {
    ...
    public ShortUrl() {}
    public ShortUrl(@NotNull(message = "url is required") String url, String shortCode) {
        this.url = url;
    ...
    public ShortUrl(int id, @NotNull(message = "url is required") String url, String shortCode) {
        this.id = id;
        this.url = url;
        this.shortCode = shortCode;
        this.createdAt = new Date();
